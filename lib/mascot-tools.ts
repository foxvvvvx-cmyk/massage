...
const NAVIGATE_SCHEMA = {
    type: "object",
    properties: {
        page: { type: "string", enum: ["chat", "characters", "story", "calendar", "music", "resources", "settings"], description: "页面名" },
...
export function buildMascotToolsListPrompt(): string {
    ...
    lines.push("  参数：");
    lines.push("    · page (必填) — 页面名。可选值：chat / characters / story / calendar / music / resources / settings");
